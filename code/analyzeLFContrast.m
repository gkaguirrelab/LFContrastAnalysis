...
analysisParams.sessionFolderName = {'KAS25_2018-10-13'};
analysisParams.sessionDate       = {'2018-10-13'};
...
analysisParams.LMVectorAngles = [ -45, 45, 0, 90]; 
analysisParams.directionCoding = vectorAngle2LMScontrast(analysisParams.LMVectorAngles,'LM'); 
analysisParams.maxContrastPerDir = [0.12,0.60,0.14,0.22]; % max contrast in the same order as above
